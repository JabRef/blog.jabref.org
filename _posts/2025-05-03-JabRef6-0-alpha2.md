...
Be aware that currently the update notification is broken. It will inform you that a new version of JabRef is available, even though you have downloaded the latest release. Just ignore this message and the version.
