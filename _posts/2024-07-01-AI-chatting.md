...
We value your opinion and we want to know: what AI features would you like to see in JabRef in future? What LLM providers (Azure, Google, Mistral, Anthrophic, etc.) you would like to have in next versions?
