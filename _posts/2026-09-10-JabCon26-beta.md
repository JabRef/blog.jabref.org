...
As a User you expect Undo and Redo to work out of the box and do not usually think about it. Well, turned out in JabRef it did not always work as expected. Over the last months we worked hard to unify the Undo and Redo implementations and fix bugs along the way.
