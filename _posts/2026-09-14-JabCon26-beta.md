...
![aboutDialog_JabRef6.0Beta.png](../img/aboutDialog_JabRef6.0Beta.png)
...
LaTeX users might also appreciate the new bst-Style support. JabRef can now parser and render .bst files, allowing users to have previews that resemble the output of the rendered LaTeX document.
...
One of the new features is the possibility to define native queries for SLRs. For more details refer to the blog post [Systematic Literature Reviews in JabRef](2026-08-01-systematic-literature-reviews-in-jabref.md)
