...
2. **Cite with Flexibility**: Insert citations (similar to natbib's `\cite`) as well as in-text citations (similar to natbib's and `\citet`) directly into your LibreOffice document.
